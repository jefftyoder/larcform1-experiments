...
## 20-day production suite vs Pithan ensemble (2026-07-09)

> **CORRECTION (2026-07-10): these runs were NOT actually calibrated.** The
...
> they are "default parameters + v10 ice-nucleation physics". Overlays now
> fixed to `coupler_toml:` (verified via dry-run construction: all six
> calibrated values land in the atmos parameter log); suite rerun pending.
> Surface-energy-balance conclusions (ts ordering, snow insulation) should be
> robust; cloud/glaciation metrics below must be reinterpreted — default
> Frostenberg a = 1 gives ~4× more INPs than the calibrated 0.254.

Three 20-day coupled runs (calibrated microphysics, reference s11 atmosphere
...
parameter log. 20-day suite rerun pending.
